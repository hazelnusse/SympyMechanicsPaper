...
whose equations of motion have been found with Kane's Method; this ensures that
only ordinary differential equations are generated and no differential
algebraic equations arise.  While the use of Kane's Method is not required for
this procedure, equations of motion which can be completely described by a series
of ODEs is a requirement.
...
\begin{align}
    \label{eq:structure}
    \tilde{M} \dot{\bm{x}} = \tilde{A} \bm{x}_i + \tilde{B} r
\end{align}
...
\begin{enumerate}
    ...
    \item Choose a point of linearization and:
        \begin{enumerate}
