...
\begin{table}[htbp]
  ...
  \begin{tabular}[c]{r @{ $=$ } l l}
    ...
    \hline
    $\bm{f}_{c}(\bm{q}, t)$ & $\bm{0}$ & $\bm{f}_c : \mathbf{R}^n \times \mathbf{R} \to
\mathbf{R}^l$ \\
$\bm{f}_{v}(\bm{q}, \bm{u}, t)$ & $\bm{0}$ & $\bm{f}_v : \mathbf{R}^n \times
\mathbf{R}^o \times \mathbf{R} \to \mathbf{R}^m$ \\
$\bm{f}_{a}(\bm{q}, \bm{\dot{q}}, \bm{u}, \bm{\dot{u}}, t)$ & $\bm{0}$ &
$\bm{f}_a : \mathbf{R}^n \times \mathbf{R}^n \times \mathbf{R}^o \times
\mathbf{R}^o \times \mathbf{R} \to \mathbf{R}^m$ \\
